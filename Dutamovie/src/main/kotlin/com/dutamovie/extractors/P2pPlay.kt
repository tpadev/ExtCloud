...
class P2pPlay : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        // token bisa ada di hash (#token) atau path terakhir
        val rawToken = when {
        ...
        // 1) Coba endpoint API yang umum dipakai varian player
        ...
        // 2) Fallback: parse halaman langsung untuk pattern m3u8
        runCatching {
