...
class NontonAnimeIDProvider : MainAPI() {
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        val title = doc.selectFirst("h1.entry-title.cs")
            ?.text()
    ...
    override suspend fun loadLinks(
        ...
        doc.select("iframe[data-src], iframe[src]")
            .mapNotNull {
        ...
        doc.select(".container1 ul.player li:not(.boxtab)")
            .map {
                async {
